...
export default function Hindu() {
 ...
 const carouselData = [
    ...
    },
    {
     ...
     const cardImages = [
  { src: 'first_img.jpg', title: 'Anjali & Ramesh' },
  { src: 'second.jpg', title: 'Priya & Arjun' },
  { src: 'third.jpg', title: 'Meera & Sanjay' },
  { src: 'four.jpg', title: 'Kavya & Rohit' },
  { src: 'five.jpg', title: 'Divya & Karthik' },
  { src: 'second.jpg', title: 'Lakshmi & Vivek' }
];

const moments = [
  
  { img: 'second.jpg', caption: 'Sacred Fire' },
  { img: 'third.jpg', caption: 'Garland Ceremony' },
  { img: 'four.jpg', caption: 'Haldi Fun' },
  { img: 'five.jpg', caption: 'Mehendi Art' },
  { img: 'second.jpg', caption: 'Sindoor Ritual' }
];
 ...
 useEffect(() => {
  ...
  return (
    ...
    <div>
      ...
      >
        <h1 className="display-3 fw-bold">HINDU WEEDING</h1>
      </div>
                   <>
      {/* Section 1: Intro */}
      <section className="intro py-5 text-center" id="next-section">
        <Container>
          <h2>Hindu Wedding Memories</h2>
          <p>
            “Every ritual tells a story, every smile holds a promise — experience the beauty of traditions through our lens.”
          </p>
        </Container>
      </section>
